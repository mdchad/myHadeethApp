import { View, Text, TouchableWithoutFeedback, Keyboard, Image, ScrollView, useWindowDimensions, StyleSheet } from 'react-native'
                ...
                <ScrollView>
                    <View className="p-3 flex items-center space-y-10">
                        <View className="mx-5 space-y-5">
                            <Text className={`text-${100 / fontScale} font-bold text-center leading-none tracking-tight mx-5`} style={styles.sectionTitle}>
                                Hadeeth of the Day
                            </Text>

                            <View className="bg-[#DAD8734D] space-y-3 p-5 rounded-md">
                                <Text className="font-bold">Sahih Muslim - Kitab Faraid</Text>
                                <Text>L(1614) حَدَّثَنَا يَحْيَى بْنُ يَحْيَى، وَأَبُو بَكْرِ بْنُ أَبِي شَيْبَةَ، وَإِسْحَاقُ بْنُ إِبْرَاهِيمَ، وَاللَّفْظُ لِيَحْيَى، قَالَ يَحْيَى: أَخْبَرَنَا، وقَالَ الْآخَرَانِ: حَدَّثَنَا ابْنُ عُيَيْنَةَ، عَنِ الزُّهْرِيِّ، عَنْ عَلِيِّ بْنِ حُسَيْنٍ، عَنْ عَمْرِو بْنِ عُثْمَانَ، عَنْ أُسَامَةَ بْنِ زَيْدٍ، أَنَّ النَّبِيَّ صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ، قَالَ: لَا يَرِثُ الْمُسْلِمُ الْكَافِرَ، وَلَا يَرِثُ الْكَافِرُ</Text>
                            </View>
                        ...
                        <View className="flex items-center justify-center">
                            <Text className="text-2xl text-center">EXPLORE RELATED HADEETH</Text>
