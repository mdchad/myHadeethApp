...
import ZeroDegree from '@components/ZeroDegree--extracted-from-package.js';
      ...
      <Grid style={{ backgroundColor: 'black' }}>
        ...
        <Row style={{ alignItems: 'center' }} size={2}>
          ...
          <Col style={{ alignItems: 'center' }}>
            ...
            <Image source={require("@assets/compass-qibla.png")} style={{
              height: width,
              justifyContent: 'center',
              alignItems: 'center',
              resizeMode: 'contain',
              transform: [{ rotate: 0 - magnetometer + 'deg' }],
              position: 'relative'
            }} />
          </Col>
        </Row>
